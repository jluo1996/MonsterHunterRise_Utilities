...
class AutoLikeMod(REFrameWorkDependentMod):
    def __init__(self, resource_folder: str, game_install_path: str, state_file_helper, logger):
        ...
        self.name = "Auto Like"
        self.description = "Automatically sends a Like' to party members upon completing a quest during multiplayer."
        self.mod_file_path = self.resource_folder / "AutoLikes"
