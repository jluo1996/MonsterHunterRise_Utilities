...
class FileHelper:
    ...
    def get_log_folder_path(self):
        log_folder = self._get_app_data_folder_path() / "MHR_Utilities_Logs"
        log_folder.mkdir(parents=True, exist_ok=True)
        return log_folder
    
    def get_install_state_file_path(self):
        install_state_file_path = self._get_app_data_folder_path() / "mhr_utilities_install_state.json"
        try:
    ...
    def _get_app_data_folder_path(self):
